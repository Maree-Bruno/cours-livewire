<main class="main-content px-4 py-8 md:flex-1 md:p-12 md:overflow-y-auto ">
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a class="btn-indigo"
           href="/organizations/create" wire:navigate><span>Create</span><span class="hidden md:inline">&nbsp;
                Organization</span></a>
    </div>
            ...
            @foreach($this->organizations as $organization)
                <tr class="hover:bg-gray-100 focus-within:bg-gray-100">
                    <td class="border-t"><a class="flex items-center px-6 py-4 focus:text-indigo-500"
                                            href="/organizations/{{ $organization->id }}/edit" wire:navigate>{!! $this->highlightText($organization->name, $search) !!}</a>
                    </td>
    ...
    {{ $this->organizations->links('vendor.livewire.ping', data:['scrollTo'=>false]) }}
</main>
