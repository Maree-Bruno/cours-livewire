            ...
            <div class="max-w-3xl bg-white rounded-md shadow overflow-hidden">
                <form wire:submit="save">
                    <div class="flex flex-wrap -mb-8 -mr-6 p-8">
                        ...
                        <div class="pb-8 pr-6 w-full lg:w-1/2">
                            ...
                            <select id="select-input-f7e0fabc-6161-47c8-9d2f-a1972054fde4"
                                    class="form-select" wire:model.change="form.country">
                                <option></option>
                    ...
                    <div class="flex items-center px-8 py-4 bg-gray-50 border-t border-gray-100"
                         x-data="{ click: false }">
                        <button class="text-red-600 hover:underline" tabindex="-1" type="button">Delete Organization
                        </button>
                        <button class="flex items-center btn-indigo ml-auto"
                                @click="click = true; setTimeout(() => click = false, 500)" type="submit"><span
                                :class="click ? 'btn-spinner' : ''" class="mr-2"></span> Update Organization
                        </button>
                    </div>
                </form>
            </div>
